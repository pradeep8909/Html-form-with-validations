...
function loop()                                    
{ 
    var email = document.forms["login"]["E-mail"];               
    var phone = document.forms["login"]["phonenumber"];    
    var name = document.getElementById("name1").value;  
    var password = document.getElementById("pass").value;  
    var first = document.forms["login"]["fname"];  
    var last = document.forms["login"]["lname"]; 
